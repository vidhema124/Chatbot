...
public class ChatMessageController {
	...
	public ResponseEntity<?> chatWithGPT(@RequestParam String message, @RequestParam String userId) {
		return chatbotService.chatWithGPT(message, userId);
	}

	@GetMapping("/openaiimage")
	public ResponseEntity<?> generateImage(@RequestParam String prompt, @RequestParam String userId) {
		return chatbotService.generateImage(prompt, userId);
	}

	@GetMapping("/huggingface")
	public ResponseEntity<?> generateImage(@RequestParam String prompt, @RequestParam ObjectId userId) {
		return chatbotService.generateImages(userId, prompt);
	}
